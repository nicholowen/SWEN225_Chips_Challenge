...
public class Render {
   ...
   */
  public void update(RenderTuple tuple, int timeRemaining, String event, boolean recording, boolean replaying, int replaySpeed) {
    gp.update(tuple);
    sp.update(timeRemaining, tuple, event, recording, replaying, replaySpeed);
