...
//     *
//     * @param maze get the time remaining from the game
//     */
...
//
//                    .add("timeRemaining", maze.getTimeRemaining());
...
//            1000 = 1.0s (fast)
//     */
//    public static void playByStep(Maze maze) {
//        try {
...
//                if (moves.size() > 0) {
//                    isRunning = false;
//                    maze.setTimeRemaining(remainingTimeAfterRun);
//                }
////                game.runMove();
//            }
...
//     * @param game the game
//     */
//    public static void runReplay(Maze maze) {
//
//        maze.setFPS((int) (1000 / playbackSpeed));
//
